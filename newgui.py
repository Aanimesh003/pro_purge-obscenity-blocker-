...
def show_main_page():
    ...
    app = DeskApp(root)  # Create an instance of DeskApp
    app.start_button.pack(pady=10)  # Show the "Start" button
    app.stop_button.pack(pady=10)   # Show the "Stop" button
    app.audio_button.pack()  # Show the "Detect Audio" button
